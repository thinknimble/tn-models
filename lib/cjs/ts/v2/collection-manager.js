...
const createCollectionManager = ({ fetchList, list: feedList, filters, pagination: feedPagination = pagination_1.default.create(), refreshing: feedRefreshing = false, loadingNextPage: feedLoadingNextPage = false, }) => {
