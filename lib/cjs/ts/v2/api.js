...
exports.createApi = exports.createCustomServiceCall = void 0;
...
function createApi({ models, client, endpoint, }, customServiceCalls = undefined) {
    ...
    name) => (input) => __awaiter(this, void 0, void 0, function* () {
        const utilsResult = (0, utils_1.createApiUtils)({
            name,
        ...
        return serviceCallOpts.callback(Object.assign(Object.assign({ client,
            endpoint }, inputResult), (utilsResult ? utilsResult : {})));
    });
    ...
    const retrieve = (id) => __awaiter(this, void 0, void 0, function* () {
        ...
        const parsed = (0, response_1.parseResponse)({
            identifier: `${retrieve.name} ${uri}`,
            data: res.data,
            zod: zod_1.z.object((0, utils_1.getSnakeCasedZodRawShape)(models.entity)),
        });
    ...
    const create = (inputs) => __awaiter(this, void 0, void 0, function* () {
        ...
        const snakedEntityShape = (0, utils_1.getSnakeCasedZodRawShape)(models.entity);
        const parsed = (0, response_1.parseResponse)({
    ...
    const list = (params) => __awaiter(this, void 0, void 0, function* () {
        ...
        const snakedCleanParsedFilters = snakedFilters
            ...
            : undefined;
        const paginatedZod = (0, utils_1.getPaginatedSnakeCasedZod)(models.entity);
        const res = yield client.get(slashEndingEndpoint, {
