...
function createCustomServiceCall(opts) {
    if (!opts.inputShape && !opts.outputShape) {
        // no input nor output
        return Object.assign(Object.assign({}, opts), { inputShape: zod_1.z.void(), outputShape: zod_1.z.void() });
    }
    if (opts.inputShape && opts.outputShape) {
        // both input n output
        return opts;
    ...
    if (opts.inputShape) {
        // only input
        return Object.assign(Object.assign({}, opts), { outputShape: zod_1.z.void() });
    }
    // only output
    return Object.assign(Object.assign({}, opts), { inputShape: zod_1.z.void() });
}
...
function createApi({ models, client, endpoint }, customServiceCalls = undefined) {
    ...
    const createCustomServiceCallHandler = (serviceCallOpts) => (inputs) => __awaiter(this, void 0, void 0, function* () {
    ...
    const modifiedCustomServiceCalls = customServiceCalls
        ? Object.fromEntries(Object.entries(customServiceCalls).map(([k, v]) => [
            k,
    ...
    if (!modifiedCustomServiceCalls)
        return baseReturn;
    return Object.assign(Object.assign({}, baseReturn), { customServiceCalls: modifiedCustomServiceCalls });
}
